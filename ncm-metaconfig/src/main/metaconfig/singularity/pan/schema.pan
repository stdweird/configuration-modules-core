...
type type_singularity_allow_ns = {
    @{Should we allow users to request the PID namespace?}
    'ns' : boolean = true
} = dict();

type type_singularity_allow = {
    ...
    'setuid' : boolean = true
    'pid' : type_singularity_allow_ns
} = dict();

type type_singularity_user = {
...
type type_singularity_bind_path = {
...
type type_singularity_bind_user_control = {
...
type type_singularity_bind_user = {
    'bind' : type_singularity_bind_user_control
} = dict();

type type_singularity_container = {
    ...
    'dir' : directory = '/var/singularity/mnt'
} = dict();

type type_singularity_sessiondir = {
...
type service_singularity = {
    'allow' : type_singularity_allow
    'config' : type_singularity_user
    'enable' : type_singularity_overlay
    'mount' : type_singularity_mount
    'bind' ? type_singularity_bind_path
    'user' : type_singularity_bind_user
    'container' : type_singularity_container
    'sessiondir' ? type_singularity_sessiondir
};
