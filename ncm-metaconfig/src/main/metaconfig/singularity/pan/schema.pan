...
type type_singularity_user_config = {
...
type type_singularity_container = {
    ...
    'container-dir' : directory = '/var/singularity/mnt'
...
type service_singularity = {
    include type_singularity_allow
    include type_singularity_user_config
    include type_singularity_mount
    include type_singularity_bind
    include type_singularity_container
};
